...
<?php $__env->startSection('content'); ?>
    <div class="container py-5">
        <a href="<?php echo e(route('booking.details' , $hotel->id)); ?>" class="btn btn-outline-secondary mb-4">← Назад</a>
        ...
        <form method="POST" action="<?php echo e(route('booking.pay', $hotel->id)); ?>" class="row g-4">
            ...
            <form method="POST" action="<?php echo e(route('booking.pay', $hotel->id)); ?>">
                <?php echo csrf_field(); ?>

                <div class="container py-5">
                    <h2 class="text-center fw-bold mb-4"><?php echo e($hotel->name); ?></h2>
                        ...
                        <div class="col-lg-8">
                            <div class="card shadow-sm mb-4">
                                <div class="card-body p-4">
                                    ...
                                    <input type="hidden" name="guests" value="<?php echo e(session('booking_data.guests') ?? 1); ?>">
                                ...
                                <div class="card-body">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex justify-content-between">
                                            ...
                                            <strong><?php echo e(number_format($hotel->price_per_night)); ?> $</strong>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between">
                                            ...
                                            <strong id="totalAmount"><?php echo e(number_format($hotel->price_per_night)); ?> $</strong>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <script>
                ...
                const pricePerNight = <?php echo e($hotel->price_per_night); ?>;
