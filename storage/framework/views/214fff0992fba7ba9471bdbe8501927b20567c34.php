...
<head>
    ...
    <style>
        .masthead {
            position: relative;
            background-image: url(<?php echo e(asset('assets/img/header-bg.jpg')); ?>);
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="testimonial-item">
                    <img class="mx-auto rounded-circle" src="<?php echo e(asset('assets/img/avatars/1.png')); ?>" alt="..." />
                    <h4>Anna Ivanova</h4>
            ...
            <div class="col-md-4">
                <div class="testimonial-item">
                    <img class="mx-auto rounded-circle" src="<?php echo e(asset('assets/img/avatars/2.png')); ?>" alt="..." />
            ...
            <div class="col-md-4">
                <div class="testimonial-item">
                    <img class="mx-auto rounded-circle" src="<?php echo e(asset('assets/img/avatars/3.png')); ?>" alt="..." />
...
<div class="portfolio-modal modal fade" id="portfolioModal1" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="close-modal" data-bs-dismiss="modal"><img src="<?php echo e(asset('assets/img/room1.jpg')); ?>" alt="Close modal" /></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="modal-body">
                            ...
                            <img class="img-fluid d-block mx-auto" src="<?php echo e(asset('assets/img/room1.jpg')); ?>" alt="..." />
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="modal-body">
                            ...
                            <h2 class="text-uppercase">Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img src="<?php echo e(asset('assets/img/room1.jpg')); ?>"/>
                            <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                            <ul class="list-inline">
                                <li>
                                    <strong>Client:</strong>
