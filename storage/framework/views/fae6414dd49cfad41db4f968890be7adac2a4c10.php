<?php $__env->startSection('content'); ?>
    <div class="container py-5">
        <h2 class="text-center mb-4 fw-bold">
            Информация о госте для: <span class="text-primary"><?php echo e($hotel->name); ?></span>
        </h2>

        <form method="POST" action="<?php echo e(route('booking.details.submit', $hotel->id)); ?>"
            ...
            <div class="text-end">
                <a href="<?php echo e(route('booking.create', $hotel->id)); ?>" class="btn btn-success btn-lg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp4\htdocs\hotel-system\resources\views/booking/guest-details.blade.php ENDPATH**/ ?>